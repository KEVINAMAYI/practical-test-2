...
onMounted(()=>{
    ...
    contractStore.getContract(props.contractID)
})
...
<template>
    <main class="relative z-10">
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div v-if="contractStore.success.message"
            ...
            <div v-if="contractStore.errors.error"
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Contract</h2>
                <form @submit.prevent="contractStore.updateContract()">
                    <div class="grid sm:col-span-2 sm:gap-6">
                        <div class="w-full">
                            <label for="contract_number"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Contract Number</label>
                            <input type="text" v-model="contractStore.contract.contract_number" name="contract_number" id="contract_number"
                        ...
                        <div class="w-full">
                            ...
                            <select required id="travel_agent_id" v-model="contractStore.contract.travel_agent_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="w-full">
                            <label for="start_date"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Start Date</label>
                            <input type="date" v-model="contractStore.contract.start_date" name="start_date" id="start_date"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            <label for="end_date"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                End Date</label>
                            <input type="date" v-model="contractStore.contract.end_date" name="end_date" id="end_date"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                   placeholder="Kenya" required="">
                        ...
                        <div class="w-full">
                            ...
                            <select required id="exclusive" v-model="contractStore.contract.exclusive" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
                            <p v-if="contractStore.errors.exclusive"
                               class="mt-2 text-xs text-red-600 dark:text-red-400"><span
                                class="font-medium">{{ contractStore.errors.exclusive[0] }}</span></p>

                        </div>
                        <div class="w-full">
                            <label for="standard_rate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Standard Rack Rate</label>
                            <input type="text" name="standard_rate" v-model="contractStore.contract.standard_rate" id="standard_rate"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" name="description" v-model="contractStore.contract.description" rows="5"
