...
<template>
    <main class="relative z-10">
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div style="margin-top:20px;" v-if="accommodationBookingStore.success.message"
            ...
            <div style="margin-top:20px;"  v-if="accommodationBookingStore.errors.error"
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create Booking</h2>
                <form @submit.prevent="accommodationBookingStore.addAccommodationBooking(form)">
                    <div class="grid sm:col-span-2 sm:gap-6">
                        <div class="w-full">
                            ...
                            <select required id="contract_id" v-model="form.contract_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <p v-if="accommodationBookingStore.errors.contract_id"
                               class="mt-2 text-xs text-red-600 dark:text-red-400"><span
                                class="font-medium">{{ contractStore.errors.contract_id[0] }}</span></p>

                        </div>
                        <div class="w-full">
                            <label for="accommodation_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Accommodation</label>
                            <select required id="accommodation_id" v-model="form.accommodation_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <p v-if="accommodationBookingStore.errors.accommodation_id"
                               class="mt-2 text-xs text-red-600 dark:text-red-400"><span
                                class="font-medium">{{ contractStore.errors.accommodation_id[0] }}</span></p>
