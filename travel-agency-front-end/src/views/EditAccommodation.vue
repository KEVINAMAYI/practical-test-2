...
const props = defineProps(['accommodationID'])

const accommodationStore = useAccommodationStore()

onMounted(()=>{
    accommodationStore.getAccomodation(props.accommodationID);
})
...
<template>
    <main class="relative z-10">
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div v-if="accommodationStore.success.message"
            ...
            <div v-if="accommodationStore.errors.error"
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                ...
                <form @submit.prevent="accommodationStore.updateAccommodation()">
                    <div class="grid sm:col-span-2 sm:gap-6">
                        <div class="w-full">
                            <label for="name"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First
                                Name</label>
                            <input type="text" v-model="accommodationStore.accommodation.name" name="name" id="name"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" name="description" v-model="accommodationStore.accommodation.description" rows="5"
                        ...
                        <div class="w-full">
                            <label for="country"
                                ...
                                Country</label>
                            <input type="text" v-model="accommodationStore.accommodation.country" name="country" id="country"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="city" v-model="accommodationStore.accommodation.city" id="city"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="address" v-model="accommodationStore.accommodation.address" id="address"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="standard_rack_rate" v-model="accommodationStore.accommodation.standard_rack_rate" id="standard_rack_rate"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
