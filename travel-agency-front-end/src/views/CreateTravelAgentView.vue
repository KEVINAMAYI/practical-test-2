...
<template>
    <main class="relative z-10">
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div style="margin-top:20px;"  v-if="travelAgentStore.success.message"
            ...
            <div style="margin-top:20px;"  v-if="travelAgentStore.errors.error"
            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-5">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create a Travel Agent</h2>
                <form @submit.prevent="travelAgentStore.addTravelAgent(form)">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="w-full">
                            ...
                            <input type="text" v-model="form.first_name" name="first_name" id="first_name"
                                   ...
                                   placeholder="Kevin Amayi" required="">
                        ...
                        <div class="w-full">
                            ...
                            <p v-if="travelAgentStore.errors.password"
                               class="mt-2 text-xs text-red-600 dark:text-red-400"><span
                                class="font-medium">{{ travelAgentStore.errors.password[0] }}</span></p>
                        </div>
                        <div class="sm:col-span-2">
                            <label for="experience"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Experience</label>
                            <textarea id="experience" name="experience" v-model="form.experience" rows="5"
                        ...
                        <div class="sm:col-span-2">
                            <label for="about_me"
                                ...
                                Me</label>
                            <textarea id="about_me" name="about_me" rows="5" v-model="form.about_me"
                                      class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
