...
watch(searchQuery,debounce(()=>{
    travelAgentStore.searchTravelAgent(searchQuery.value);
},500))
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        <tr v-for="travelAgent in travelAgentStore.travelAgents" :key="travelAgent.id" class="border-b dark:border-gray-700">
                            <td class="px-4 py-3">{{ travelAgent.user.first_name }}</td>
                            <td class="px-4 py-3">{{ travelAgent.user.last_name }}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ travelAgent.user.email }}</td>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ travelAgent.about_me }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <router-link :to="{ name :'edit-travel-agent', params:{ travelAgentID :travelAgent.id }}"
                                ...
                                <button @click="travelAgentStore.deleteTravelAgent(travelAgent.id)"
                                    class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                    type="button">
