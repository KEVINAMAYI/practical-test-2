...
watch(searchQuery,debounce(()=>{
    accommodationStore.searchAccomodations(searchQuery.value);
},500));
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Rack Rate</th>
                        ...
                        <tbody>
                        <tr v-for="accommodation in accommodationStore.accommodations" :key="accommodation.id" class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ accommodation.name }}
                            </th>
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ accommodation.description }}</td>
                            <td class="px-4 py-3">
                                {{accommodation.country}}, {{ accommodation.city}}</td>
                            <td class="px-4 py-3">{{ accommodation.standard_rack_rate }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                <router-link :to="{ name:'edit-accommodation', params:{ accommodationID : accommodation.id }}"
                                ...
                                <button @click="accommodationStore.deleteAccommodation(accommodation.id)"
                                        class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                                        type="button">
